      ...
      <div className="bg-gradient-to-r from-green-600 to-emerald-600 text-white py-8">
        <div className="max-w-md mx-auto px-4">
          ...
          <div>
            ...
            <h1 className="text-3xl font-bold mb-2">Module 4: Using Options</h1>
            <p className="text-green-100 text-base">When options beat futures</p>
          </div>
        </div>
      </div>
          ...
          <div className="text-center py-12">
            ...
            <div className="space-y-2 text-left bg-green-50 rounded-lg p-4">
              ...
              <div className="flex items-center gap-2 text-gray-700">
                ...
                <span>Put options explained</span>
              </div>
              <div className="flex items-center gap-2 text-gray-700">
                <div className="w-2 h-2 rounded-full bg-green-400" />
                <span>When options beat futures</span>
              </div>
              <div className="flex items-center gap-2 text-gray-700">
                <div className="w-2 h-2 rounded-full bg-green-400" />
                <span>Cost vs protection</span>
              </div>
            </div>
            <Link 
              href="/learn-hedging"
