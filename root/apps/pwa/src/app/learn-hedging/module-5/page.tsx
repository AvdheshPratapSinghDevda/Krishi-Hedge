      ...
      <div className="bg-gradient-to-r from-green-600 to-emerald-600 text-white py-8">
        <div className="max-w-md mx-auto px-4">
          ...
          <div>
            ...
            <h1 className="text-3xl font-bold mb-2">Module 5: Managing Positions</h1>
            <p className="text-green-100 text-base">Tracking and managing your hedges</p>
          </div>
        </div>
      </div>
          ...
          <div className="text-center py-12">
            ...
            <div className="space-y-2 text-left bg-green-50 rounded-lg p-4">
              ...
              <div className="flex items-center gap-2 text-gray-700">
                ...
                <span>Tracking hedges</span>
              </div>
              <div className="flex items-center gap-2 text-gray-700">
                <div className="w-2 h-2 rounded-full bg-green-400" />
                <span>When to exit</span>
              </div>
              <div className="flex items-center gap-2 text-gray-700">
                <div className="w-2 h-2 rounded-full bg-green-400" />
                <span>Working with brokers</span>
              </div>
            </div>
            <Link 
              href="/learn-hedging"
