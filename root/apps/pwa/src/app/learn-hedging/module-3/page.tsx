      ...
      <div className="bg-gradient-to-r from-green-600 to-emerald-600 text-white py-8">
        <div className="max-w-md mx-auto px-4">
          ...
          <div>
            ...
            <h1 className="text-3xl font-bold mb-2">Module 3: Build Your Strategy</h1>
            <p className="text-green-100 text-base">Planning your hedging approach</p>
          </div>
        </div>
      </div>
